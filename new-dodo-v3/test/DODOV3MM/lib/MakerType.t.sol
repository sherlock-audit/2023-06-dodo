...
contract MakerTypesHelper {
    ...
    {
        (uint256 askUpPrice, uint256 askDownPrice, uint256 bidUpPrice, uint256 bidDownPrice, uint256 swapFee) =  MakerTypes.parseAllPrice(priceInfo, tokenDecimal, mtFeeRate);
...
contract MakerTypeTest is TestContext {
    ...
    function testParseAllPrice() public {
        ...
        assertEq(askUpPrice, 27913456 * (10 ** 25)); //decimal is 28
        assertEq(askDownPrice, 27902304 * (10 ** 25)); // decimal is 28
        assertEq(bidUpPrice, 3590); // decimal is 8, 0.00003590
        assertEq(bidDownPrice, 3589); // decimal is 8
