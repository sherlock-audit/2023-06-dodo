...
contract D3MMTest is TestContext {
    ...
    function testSetNewMaker() public {
        ...
        newD3Maker.setNewToken(address(token2), true, token2Info.priceInfo, token2Info.amountInfo, token2Info.kAsk, token2Info.kBid, 18);
        newD3Maker.setNewToken(address(token3), true, token2Info.priceInfo, token2Info.amountInfo, token2Info.kAsk, token2Info.kBid, 18);
        vm.stopPrank();
